    ...
    Scheduler.plugin = function (t) {
        ...
        g.init = function (t, e, i) {
            ...
            g.set_actions = function () {
                ...
                this._select_id != t && (g._close_not_saved(), this.editStop(!1), this.unselect(), this._select_id = t, this.updateEvent(t))
            ...
            g._on_dbl_click = function (t, e) {
                ...
                if (a) e = a.call(this, e);
                    ...
                    e.y = Math.ceil(24 * (Math.max(0, r) + 7 * Math.max(0, s - 1)) * 60 / this.config.time_step),
                        (g._drag_mode || "month" == this._mode) && (e.y = 24 * (Math.max(0, Math.ceil(r) - 1) + 7 * Math.max(0, s - 1)) * 60 / this.config.time_step), "move" == this._drag_mode && g._ignores_detected && g.config.preserve_length && (e._ignores = !0, this._drag_event._event_length || (this._drag_event._event_length = this._get_real_event_length(this._drag_event.start_date, this._drag_event.end_date, {
                            x_step: 1,
                            x_unit: "day"
                        }))), e.x = 0
                        ...
                        if (g.matrix && (o = g.matrix[g._mode]), o = o || {
                            ...
                            if (i = l.start_date.valueOf(), n = l.end_date.valueOf(), this._table_view) {
                                ...
                                n = Math.abs(x - y) > Math.abs(b - y) ? c + b : c + x,
                                    n += 6e4 * (new Date(n).getTimezoneOffset() - u.getTimezoneOffset()), this._els.dhx_cal_data[0].style.cursor = "s-resize", "week" != this._mode && "day" != this._mode || (n = this._correct_shift(n))
                            }
        ...
        g.$env = {
            ...
            _call: function (t, e, i, n, a, r, s) {
                ...
                }), "GET" != t || this.cache || (e += (e.indexOf("?") >= 0 ? "&" : "?") + "dhxr" + (new Date).getTime() + "=1"), d.open(t, e, n), s)
        ...
        g.date = {
            ...
            date: {
                ...
                month_short: ["Thg1", "Thg2", "Thg3", "Thg4", "Thg5", "Thg6", "Thg7", "Thg8", "Thg9", "Thg10", "Thg11", "Thg12"],
                day_full: ["CN", "Thứ 2", "Thứ 3", "Thứ 4", "Thứ 5", "Thứ 6", "Thứ 7"],
            ...
            labels: {
                ...
                icon_delete: "Xóa",
                confirm_closing: "",
                confirm_deleting: "Sự kiện này sẽ bị xóa, bạn chắc chắn chứ?",
            ...
            g.clear_event = function (t) {
                ...
                k += '<div class="dhx_event_move dhx_title dhx-title-giang-day" style="' + f + v + '">' + s + "</div>", k += '<div class="dhx_body" style=" width:' + y + "px; height:" + D + "px;" + f + v + '">' + o + "</div>";
                ...
                if (e = e || g._mode,
                    ...
                    var r = i.color,
                        s = i.textColor;
                    if (g.config.highlight_displayed_event && (i.color = g.config.displayed_event_color, i.textColor = g.config.displayed_event_text_color), g.setCurrentView(new Date(i.start_date), e), i.color = r, i.textColor = s, g.config.scroll_hour = n, g.config.preserve_scroll = a,
                        g.matrix && g.matrix[e]) {
                        var o = g.getView(),
                            d = o.y_property,
                            l = g.getEvent(i.id);
                        if (l) {
                            ...
                            h -= (c.offsetWidth - o.dx) / 2, _ = _ - c.offsetHeight / 2 + o.dy / 2, o.scrollTo({
                                left: h,
                                top: _
                            })
                        }
                ...
                if (t = t || this._load_url) {
                    ...
                    if (e = e || this._date,
                        ...
                        if (n <= e) return !1;
                        for (g.$ajax.get(t + "&from=" + a(e) + "&to=" + a(n), i); e < n;) this._loaded[a(e)] = !0,
                ...
                parse: function (t) {
                    var e;
                    if (t.xmlDoc.responseXML || (t.xmlDoc.responseXML = g.$ajax.parse(t.xmlDoc.responseText)), e = g.$ajax.xmltop("data", t.xmlDoc),
                            ...
                            switch (d) {
                                ...
                                case "%H:%i":
                                    ...
                                    for (t._time_values = []; v < a;) {
                                        _ += "<option value='" + v + "'>" + this.templates.time_picker(n) + "</option>", t._time_values.push(v),
                    ...
                    set_value: function (t, e, i, n) {
                        ...
                        if (o.full_day) {
                            ...
                            h.checked = 0 === g.date.time_part(i.start_date) && 0 === g.date.time_part(i.end_date), d[l[0]].disabled = h.checked, d[l[0] + d.length / 2].disabled = h.checked, h.onclick = function () {
                                ...
                                d[l[0]].disabled = h.checked, d[l[0] + d.length / 2].disabled = h.checked, a(d, 0, r || i.start_date),
                                    a(d, 4, s || i.end_date)
                            }
                        }
            ...
            g._ready_to_dnd = function (t) {
                ...
                n(document.body, t[0], function (t) {
                    ...
                    n(this._els.dhx_cal_data[0], "contextmenu", function (t) {
                        ...
                        if (!i(t)) return g.config.touch_swipe_dates && !_ && a(o, d, 200, 100) && (g._block_next_stop = !0), _ && (g._ignore_next_click = !0, setTimeout(function () {
                    ...
                    this._dp_hook_delete = function (e, i) {
                        ...
                        if (this._validId(e)) {
                            ...
                            return "inserted" == i || this._new_event ? (t.setUpdated(e, !1),
                                !0) : "deleted" != i && ("true_deleted" == i || (t.setUpdated(e, !0, "deleted"), !1))
                        }
                ...
                return {
                    view: {
                        ...
                        init: function () {
                            var t = document.createElement("DIV");
                            t.id = "scheduler_" + g.uid(), t.style.width = "100%", t.style.height = "100%", t.classList.add("dhx_cal_container"), t.cmp = "grid",
